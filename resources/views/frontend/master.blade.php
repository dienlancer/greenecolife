...
<script>(function(d, s, id) {
  ...
  js.src = 'https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v2.12&appId=206740246563578&autoLogAppEvents=1';
		...
		<div class="container bg-wrapper"> 
			...
			<div class="col-lg-4">
				<div class="searching">
					...
					<div class="nana">
						<form action="<?php echo route('frontend.index.search'); ?>" method="post" name="frm-search" class="relative tuabin">
						{{ csrf_field() }}
